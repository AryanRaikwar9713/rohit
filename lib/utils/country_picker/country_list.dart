class CountryModel {
  ...
  CountryModel({
    ...
    this.e164Key = "",
    this.startWithDigit = const <String>[],
  });

  factory CountryModel.fromJson(Map<String, dynamic> json) {
    return CountryModel(
      e164Cc: json['e164_cc'] is String ? json['e164_cc'] : "",
      iso2Cc: json['iso2_cc'] is String ? json['iso2_cc'] : "",
      e164Sc: json['e164_sc'] is int ? json['e164_sc'] : -1,
      geographic: json['geographic'] is bool ? json['geographic'] : false,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'e164_key': e164Key,
      'startingDigits': startWithDigit.map((e) => e).toList(),
    };
  }
}
