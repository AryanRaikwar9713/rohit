...
class SettingController extends GetxController {
  Rx<Future<AboutPageResponse>> getPageListFuture =
      Future(() => AboutPageResponse()).obs;

  Rx<Future<AccountSettingResponse>> getAccountSettingFuture = Future(() =>
  ...
  Rx<ProfileModel> profileDetailsResp =
      ProfileModel(planDetails: SubscriptionPlanModel()).obs;
  ...
  Future<void> getAccountSetting({bool showLoader = false}) async {
    ...
    await getAccountSettingFuture(CoreServiceApis()
      ...
      isChildrenProfileEnabled.value =
          accountSettingResp.value.isParentalLockEnabled == 1;
  ...
  Future<void> setPin() async {
    if (newPin.value.isEmpty) {
      ...
      if (newPin.value == confirmPin.value) {
        ...
        isLoading(true);
        await CoreServiceApis()
            .changePin(newPin.value, confirmPin.value)
            .then((value) {
