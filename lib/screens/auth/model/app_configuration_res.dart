...
class ConfigurationResponse {
  ...
  factory ConfigurationResponse.fromJson(Map<String, dynamic> json) {
    return ConfigurationResponse(
      vendorAppUrl: json['vendor_app_url'] is Map
          ? VendorAppUrl.fromJson(json['vendor_app_url'])
          : VendorAppUrl(),
      ...
      flutterWavePay: json['flutterwave_pay'] is Map
          ...
          : FlutterwavePay(),
      isForceUpdateForAndroid: json['isForceUpdateforAndroid'] is int
          ? json['isForceUpdateforAndroid']
          : -1,
      androidMinimumForceUpdateCode:
          json['android_minimum_force_update_code'] is int
              ? json['android_minimum_force_update_code']
              : -1,
      androidLatestVersionUpdateCode:
          json['android_latest_version_update_code'] is int
              ? json['android_latest_version_update_code']
              : -1,
      isForceUpdateForIos:
          json['isForceUpdateforIos'] is int ? json['isForceUpdateforIos'] : -1,
      iosMinimumForceUpdateCode: json['iso_minimum_force_update_code'] is int
          ? json['iso_minimum_force_update_code']
          : -1,
      iosLatestVersionUpdateCode: json['iso_latest_version_update_code'] is int
          ? json['iso_latest_version_update_code']
          : -1,
      ...
      isUserPushNotification: json['is_user_push_notification'] is int
          ? json['is_user_push_notification']
          : -1,
      enableChatGpt:
          json['enable_chat_gpt'] is int ? json['enable_chat_gpt'] : -1,
      testWithoutKey:
          json['test_without_key'] is int ? json['test_without_key'] : -1,
      chatgptKey: json['chatgpt_key'] is String ? json['chatgpt_key'] : "",
      enableAds: json['enable_ads'] is int ? json['enable_ads'] : -1,
      interstitialAdId: json['interstitial_ad_id'] is String
          ? json['interstitial_ad_id']
          : "",
      ...
      rewardedAdId:
          json['rewarded_ad_id'] is String ? json['rewarded_ad_id'] : "",
      rewardInterstitialAdId: json['rewardinterstitial_ad_id'] is String
          ? json['rewardinterstitial_ad_id']
          : "",
      enableIosAds: json['enable_ios_ads'] is int ? json['enable_ios_ads'] : -1,
      iosInterstitialAdId: json['ios_interstitial_ad_id'] is String
          ? json['ios_interstitial_ad_id']
          : "",
      iosNativeAdId:
          json['ios_native_ad_id'] is String ? json['ios_native_ad_id'] : "",
      iosBannerAdId:
          json['ios_banner_ad_id'] is String ? json['ios_banner_ad_id'] : "",
      iosOpenAdId:
          json['ios_open_ad_id'] is String ? json['ios_open_ad_id'] : "",
      iosRewardedAdId: json['ios_rewarded_ad_id'] is String
          ? json['ios_rewarded_ad_id']
          : "",
      iosRewardInterstitialAdId: json['ios_rewardinterstitial_ad_id'] is String
          ? json['ios_rewardinterstitial_ad_id']
          : "",
      enablePicsArt:
          json['enable_picsart'] is int ? json['enable_picsart'] : -1,
      picsArtKey: json['picsart_key'] is String ? json['picsart_key'] : "",
      enableCutOutPro:
          json['enable_cutoutpro'] is int ? json['enable_cutoutpro'] : -1,
      cutOutProKey:
          json['cutoutpro_key'] is String ? json['cutoutpro_key'] : "",
      ...
      inAppPurchase:
          json['in_app_purchase'] is int ? json['in_app_purchase'] : -1,
      ...
      taxPercentage: json['tax'] is List
          ...
          : [],
      enableInAppPurchase:
          json['enable_in_app'] is int ? json['enable_in_app'] : -1,
      entitlementId:
          json['entitlement_id'] is String ? json['entitlement_id'] : "",
      googleApiKey:
...
class VendorAppUrl {
  ...
  factory VendorAppUrl.fromJson(Map<String, dynamic> json) {
    return VendorAppUrl(
      vendorAppPlayStore: json['vendor_app_play_store'] is String
          ? json['vendor_app_play_store']
          : "",
      vendorAppAppStore: json['vendor_app_app_store'] is String
          ? json['vendor_app_app_store']
          : "",
    );
  }
...
class Currency {
  ...
  Currency({
    this.currencyName = "Bolt",
    this.currencySymbol = "Bolts",
    this.currencyCode = "BOLT",
...
class Tax {
  ...
  factory Tax.fromJson(Map<String, dynamic> json) {
    return Tax(
      ...
      featureImage:
          json['feature_image'] is String ? json['feature_image'] : "",
